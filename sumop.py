...
b4=Button(tab2,text="Close", width=12,command=window.destroy,bg='#c5cae9')
...
button4=Button(tab3,text="Summarize",command=get_url_summary, width=12,bg='#25D366',fg='#fff')
button4.grid(row=5,column=1,padx=10,pady=10)
...
# About TAB
about_label = Label(tab5,text="Text Summarizer GUI \n ET-A-Group-4",pady=5,padx=5)
